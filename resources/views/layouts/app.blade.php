                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropDownToDo" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>ToDos <span class="caret"></span></a>
                                <div class="dropdown-menu"  aria-labelledby="navbarDropDownToDo">
                                    <a href="{{ route('index.todos') }}" class="dropdown-item">Index</a>
                                    <a href="{{ route('form.todo', ['schedule' => auth()->user()->defaultSchedule()]) }}" class="dropdown-item">New ToDo</a>
                                </div>
                            </li>
                        @endguest
                    </ul>
